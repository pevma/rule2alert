  ...
  def __init__(self, dict_flowbits, sidGroup, packets, total_sids_loaded, sid_to_proto_map):
	...
	for sid in self.alpha:
	  ...
	  if self.alpha.index(sid) == 0: 
	    ...
	    self.temp_packets_middle[0][IP].src = self.temp_packets[len(self.temp_packets)-2][IP].src #make sure we have the same ip, from first sid's PA
	    self.temp_packets_middle[0][IP].dst = self.temp_packets[len(self.temp_packets)-2][IP].dst #make sure we have the same ip, from first sid's PA
	    ...
	    self.temp_packets_middle[1][IP].dst = self.temp_packets_middle[0][IP].src
	    self.temp_packets_middle[1][IP].src = self.temp_packets_middle[0][IP].dst
	  ...
	  #last sid in the flowbit list  
	    ...
	    self.temp_packets_last[0][IP].src = self.temp_packets[len(self.temp_packets)-2][IP].src #make sure we have the same ip, from first sid's PA
	    self.temp_packets_last[0][IP].dst = self.temp_packets[len(self.temp_packets)-2][IP].dst #make sure we have the same ip, from first sid's PA
	    ...
	    self.temp_packets_last[1][IP].dst = self.temp_packets_last[0][IP].src
	    self.temp_packets_last[1][IP].src = self.temp_packets_last[0][IP].dst
	    ...
	    self.temp_packets_last[2][IP].dst = self.temp_packets_last[1][IP].src
	    self.temp_packets_last[2][IP].src = self.temp_packets_last[1][IP].dst
	    ...
	    self.temp_packets_last[3][IP].dst = self.temp_packets_last[2][IP].src
	    self.temp_packets_last[3][IP].src = self.temp_packets_last[2][IP].dst
